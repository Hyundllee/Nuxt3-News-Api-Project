  ...
  <div class="card">
    ...
    <div class="card__info-box">
      <div class="card__info-box__header">
        <div class="broadcast">
          <img v-bind:src="logo" alt="" class="broadcast__logo" />
          <span class="broadcast__companyName">KBS, SBS , MBC , JTBC</span>
        </div>
      ...
      <div class="card__info-box__body">
        <span class="contents">
          뉴스 기사내용 뉴스 기사내용 뉴스 기사내용 뉴스 기사내용 뉴스 기사내용
          뉴스 기사내용 뉴스 기사내용 뉴스 기사내용 뉴스 기사내용 뉴스 기사내용
        </span>
      </div>
    </div>
    ...
    <div class="card__profile-box">
      ...
      <div class="card__profile-box__detail">
        <div class="name">dogn</div>
        <div class="date">2025-00-00</div>
      </div>
    </div>
  </div>
</template>
...
const logo = computed(() => {
  return `https://t2.gatatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL=https://${website.value}&size=16`
})
</script>
